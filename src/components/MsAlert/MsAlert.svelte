<script lang="ts">
  ...
  import Shaker from 'svelte-material-icons/Shaker.svelte';
  import Alert from 'svelte-material-icons/Alert.svelte';
  import Done from 'svelte-material-icons/Donkey.svelte';
...
{#if show}
  ...
  >
    ...
    <div
      ...
      style="color: {color == 'white' ? getColor('dark') : getColor(color)};"
    >
      <slot />
    </div>
